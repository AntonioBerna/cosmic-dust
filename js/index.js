...
if (AudioContext) {
    ...
    audioPlayer.addEventListener('playing', function () {
        ...
        if (currentSourceId !== null && currentSourceId !== audioPlayer.currentSrc) {
            audioPlayer.pause();
            isPlaying = false;
        }

        currentSourceId = audioPlayer.currentSrc;
    ...
    // Il browser non supporta l'API AudioContext
    // Gestisci il caso in cui l'audio non sarà disponibile
    console.log("Il browser non supporta l'API AudioContext.");
}
